...
#define cpu_map_h
  ...
  #if N_AXIS > 3
    #define MIN_LIMIT_PORT_3 J // axis 4 - only one limit switch for the cloned y axis, used to be L
  #endif
  #if N_AXIS > 4
  ...
  #if N_AXIS > 3
    #define MIN_LIMIT_BIT_3 1  // axis 4 - only one limit switch for the cloned y axis, used to be 7 = RAMPS AUX2 pin D42
  #endif
  #if N_AXIS > 4
